...
class Emote {
     ...
     * @return static
     */
    public static function fromPacket(Human $sender, EmotePacket $emotePacket) : static {
     ...
     * @return static
     */
    public static function create(Human $entity, string $emoteId, int $flags = 0) : static {
